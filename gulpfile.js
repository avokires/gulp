...
// Set assets paths.
const paths = {
	'css': ['dist/assets/css/*.css', '!dist/assets/css/*.min.css'],
	'icons': 'assets/images/svg-icons/*.svg',
	'images': ['assets/images/*', '!assets/images/*.svg'],
	'html': ['./*.html', './helpers/*.html', '!dist/*.html'],
	'sass': 'assets/sass/**/*.scss',
	'concat_scripts': 'assets/scripts/concat/*.js',
	'scripts': ['assets/scripts/*.js', 'dist/assets/scripts/*.js', '!assets/scripts/*.min.js', '!dist/assets/scripts/*.min.js'],
...
gulp.task('clean:styles', () =>
	del(['dist/assets/css/style.css', 'dist/assets/css/style.min.css'])
);
...
gulp.task('clean:sprites', () => {
	del(['dist/assets/images/sprites.png']);
});
...
gulp.task('concat', () =>
	gulp.src(paths.concat_scripts)
		...
		// Append the sourcemap to main.js.
		.pipe(sourcemaps.write())
...
gulp.task('default', ['sprites', 'icons', 'styles', 'scripts', 'imagemin', 'html']);
